						...
						<tbody>
							...
							<tr>
								...
								<div class="btn-group">
									...
									<a class="dropdown-item" onclick="confirm('Confirm Delete Servicio id {{$row->id}}? \nDeleted Servicios cannot be recovered!')||event.stopImmediatePropagation()" wire:click="destroy({{$row->id}})"><i class="fa fa-trash"></i> Delete </a>   
									</div>
								</div>
								</td>
							@endforeach
