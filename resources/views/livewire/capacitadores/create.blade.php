    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createDataModalLabel">Create New Capacitadore</h5>
           ...
           <div class="modal-body">
            ...
            <div class="form-group">
                <label for="id_Capacitador"></label>
                <input wire:model="id_Capacitador" type="text" class="form-control" id="id_Capacitador" placeholder="Id Capacitador">@error('id_Capacitador') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group">
